...
import com.medical.view.VerticalSeekBar.OnSeekBarChangeListener;
...
public class TemperAlertActivity1 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.temper_alert1);
		initViews();
		initDatas();
	}
	...
	private void initViews(){
		tv_alert = (TextView) findViewById(R.id.textView_alert);
...
//		}
		...
		if(MainActivityBleActivity.mConnService!=null && MainActivityBleActivity.mConnService.isLink()) {
			int temper = (alertTemper-AppConstants.temper_min)/10;
			int lowTemper , bigTemper;
			if(temper>35) {
				lowTemper = 35;
				bigTemper = temper ;
			} else {
			...
			MainActivityBleActivity.mConnService.write(new byte[] {(byte)0x91, (byte)0xFF, (byte)0xFF, (byte)0xFF,  (byte) lowTemper, (byte)bigTemper});
			mSetupData.saveInt(SHARED_ALERT, alertTemper);
			finish();
		} else {
			ToastNew.makeTextMid(this, R.string.nolink, 3).show();
