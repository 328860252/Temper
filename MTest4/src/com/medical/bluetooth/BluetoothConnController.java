	        ...
	        //        mConnectedDeviceName = msg.getData().getString(DEVICE_NAME);
	         //       Toast.makeText(getApplicationContext(), "Connected to "
	          ...
	          //      Log.w(TAG, "[handleMessage] currentTimeMillis: "+ System.currentTimeMillis() );
	                sendBroadcast(writeMessage, MainActivity2.OUTGOING_MSG, msg.arg2);
	                Log.w("tag", "bluttoothConnControoller  ·¢ËÍ"+Myhex.buffer2String(writeBuf));
	                break;
	            case MESSAGE_READ:	            
	            ...
	            //    }
	         //       BluetoothConnController.this.sendMessage(readMessage);//echo 
	                sendBroadcast(readMessage, MainActivity2.INCOMING_MSG, msg.arg2);
	         ...
	         /*   	AlertDialog.Builder builder = new AlertDialog.Builder(getApplicationContext());
	            	...
	            	alert.show();*/
	            	sendBroadcast(str, MainActivity2.ALERT_MSG, msg.arg1);
	            	break;
			}	
		}
    ...
    public class MessageReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (action.equals(SEND_MSG_FROM_BT_ACTION)){
				...
				String deviceAddress = intent.getExtras().getString(MainActivity2.DEVICE_ADDRESS);
				...
				String deviceAddress = intent.getExtras().getString(MainActivity2.DISCONNECT_DEVICE_ADDRESS);
